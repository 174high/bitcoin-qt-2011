...
void ThreadSocketHandler2(void* parg)
{
    ...
    loop
    {
        ...
        CRITICAL_BLOCK(cs_vNodes)
        {
            ...
            #ifdef DEBUG_NET            
            std::cout<<__FUNCTION__<<" 1: vnode zise="<<vNodesCopy.size()<<std::endl; 
            #endif 
            BOOST_FOREACH(CNode* pnode, vNodesCopy)
            {
                #ifdef DEBUG_NET            
                std::cout<<__FUNCTION__<<" 2: vnode zise="<<vNodesCopy.size()<<std::endl;
                #endif
            ...
            #ifdef DEBUG_NET            
            std::cout<<__FUNCTION__<<" 2: vnodedisconnet zise="<<vNodesDisconnectedCopy.size()<<std::endl;
            #endif
        ...
        //
        #ifdef DEBUG_NET            
        std::cout<<__FUNCTION__<<" hListenSocket="<<hListenSocket<<std::endl;
        #endif

        #ifdef DEBUG_NET            
        std::cout<<__FUNCTION__<<" INVALID_SOCKET="<<INVALID_SOCKET<<std::endl;
        #endif

        if (hListenSocket != INVALID_SOCKET && FD_ISSET(hListenSocket, &fdsetRecv))
        {
        #ifdef DEBUG_NET            
        std::cout<<__FUNCTION__<<" Accept new connections####!!!"<<hListenSocket<<std::endl;
        #endif
